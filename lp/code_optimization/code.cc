...
#ifndef YY_YY_CODE_HH_INCLUDED
# define YY_YY_CODE_HH_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
{
  "$end", "error", "$undefined", "VAR", "NUM", "OP", "EQ", "RELOP", "IF",
  "GOTO", "NL", "$accept", "S", "line", "instruction", "val", YY_NULLPTR
};
#endif
...
{
      15,     1,     8,     9,    11,    12,     2,     3,     7,    18,
      19,    14,    17,    16,    21,     0,    13,    20
};

static const yytype_int8 yycheck[] =
{
       7,     3,     3,     4,     4,     0,     8,     9,     6,    16,
      17,    10,     5,     7,     4,    -1,     5,     9
};
...
{
       0,     3,     8,     9,    12,    13,    14,     6,     3,     4,
      15,     4,     0,    12,    10,    15,     7,     5,    15,    15,
       9,     4
};
...
#line 43 "code.y"
                      {
                        ...
                        instList[no_of_instructions++] = (yyval.str);
                    }
#line 1357 "code.cc"
    break;
...
#line 48 "code.y"
                                          {
                                            ...
                                            strcat((yyvsp[-2].str)," ");
                                            strcat((yyvsp[-1].str)," ");
                                            strcat((yyvsp[-4].str),strcat((yyvsp[-3].str),strcat((yyvsp[-2].str),strcat((yyvsp[-1].str),(yyvsp[0].str)))));
...
#line 56 "code.y"
                                        {
                                            strcat((yyvsp[-2].str)," ");
                                            strcat((yyvsp[-1].str)," ");
                                            strcat((yyvsp[-2].str),strcat((yyvsp[-1].str),(yyvsp[0].str)));
...
#line 62 "code.y"
                                                        {
											sprintf((yyvsp[0].str), "%d", (atoi((yyvsp[0].str))-1));
                                            strcat((yyvsp[-1].str)," ");
...
#line 67 "code.y"
                                        {
                                            ...
                                            strcat((yyvsp[-2].str)," ");
                                            strcat((yyvsp[-1].str)," ");
                                            strcat((yyvsp[-1].str),(yyvsp[0].str));
                                            strcat((yyvsp[-4].str),strcat((yyvsp[-3].str),strcat((yyvsp[-2].str),(yyvsp[-1].str))));
                                            strcpy((yyval.str),strcat((yyvsp[-5].str),(yyvsp[-4].str)));
                                        }
#line 1407 "code.cc"
    break;
